...
/* harmony import */ var _services_validator__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../services/validator */ "./js/services/validator.js");
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modal */ "./js/modules/modal.js");
...
function form(selectorForm, selectorName, selectorPhone) {
  ...
  (0,_services_validator__WEBPACK_IMPORTED_MODULE_10__.validateName)(selectorName);
  form.reset();
  form.addEventListener('submit', function (e) {
    e.preventDefault();
    var formDataObj = Object.fromEntries(new FormData(form).entries()),
      jsonForm = JSON.stringify(formDataObj);
    if (!(0,_services_validator__WEBPACK_IMPORTED_MODULE_10__.validateEmail)(formDataObj.email)) {
    ...
    (0,_services_services__WEBPACK_IMPORTED_MODULE_9__.getData)('api/user/checkExist.php', formDataObj).then(function (data) {
      return data.json();
    }).then(function (data) {
      if (!data.isExist) {
        ...
        createUser(jsonForm);
      } else if ((0,_services_services__WEBPACK_IMPORTED_MODULE_9__.isExpiredTime)(storageKey, lifetime)) {
        localStorage.setItem(storageKey, +new Date());
        //document.cookie = `${storageKey}=; max-age=${lifetime}`;
        createUser(jsonForm);
      } else {
      ...
      return loadingImg.remove();
    });
  });
  (0,_services_validator__WEBPACK_IMPORTED_MODULE_10__.validatePhone)(selectorPhone);
  function createUser(json) {
    (0,_services_services__WEBPACK_IMPORTED_MODULE_9__.postData)('api/user/create.php', json).then(function (data) {
      return data.json();
    }).then(function (data) {
      (0,_modal__WEBPACK_IMPORTED_MODULE_11__.showThanksModal)('modal__dialog', '.modal', message.success);
    })["catch"](function (e) {
      console.log(e);
...
function showThanksModal(modalDialogSelector, modalSelector, message) {
  var prevModalDialog = document.querySelector(".".concat(modalDialogSelector));
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   checkCookieExist: () => (/* binding */ checkCookieExist),
/* harmony export */   getData: () => (/* binding */ getData),
/* harmony export */   isExpiredTime: () => (/* binding */ isExpiredTime),
...
function _getData() {
  _getData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(url, params) {
    var result;
...
function isExpiredTime(key, limit) {
  var localStorageInitTime = localStorage.getItem(key);
...
function validatePhone(selector) {
  ...
  var phone_input = document.querySelector(selector);
...
window.addEventListener('DOMContentLoaded', function () {
  (0,_modules_form__WEBPACK_IMPORTED_MODULE_0__.form)('form', '#name', '#phone');
});
})();
